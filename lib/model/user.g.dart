...
User _userDeserialize(
  ...
  final object = User(
    ...
    joinDate: reader.readDateTimeOrNull(offsets[2]),
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> joinDateIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'joinDate',
      ));
  ...
  QueryBuilder<User, User, QAfterFilterCondition> joinDateIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'joinDate',
      ));
  ...
  QueryBuilder<User, User, QAfterFilterCondition> joinDateEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'joinDate',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> joinDateGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> joinDateLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> joinDateBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByJoinDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'joinDate', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByJoinDateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByJoinDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'joinDate', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByJoinDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'joinDate', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByJoinDate() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, DateTime?, QQueryOperations> joinDateProperty() {
    return QueryBuilder.apply(this, (query) {
